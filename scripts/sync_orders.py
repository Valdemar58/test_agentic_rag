...
Запрос заказчика 2026-09-18 (вне ТЗ): на dev-машине одной командой получить в индексе все приказы,
при повторном прогоне не трогать уже обработанные, приказы в состоянии «Зарегистрировано»
(`$KrStates_Doc_Registered`, 6) не грузить.
