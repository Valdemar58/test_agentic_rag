...
вместо отказа — 1. Наоборот, если эталон содержит конкретное значение или расчёт, а помощник говорит, \
что в документах этого нет, — это 2, даже если он привёл исходные значения.
