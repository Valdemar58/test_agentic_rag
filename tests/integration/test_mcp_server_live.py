...
Без прогрева модели не нужны: список инструментов отдаётся сразу, а глоссарий без доступной коллекции
отвечает пустым результатом с пояснением, а не ошибкой.
"""
